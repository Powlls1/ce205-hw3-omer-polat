...
namespace ce205_hw3_algo_lib
{
    public class AVLTree
    {
        ...
        /// <summary>
        /// The code starts by checking if the root node is null.
        /// If it is, then the function returns the root node.
        /// </summary>
        ...
        /// <summary>
        /// The code searches for the ID in a tree.
        /// If it finds it, then it returns 1; otherwise, it returns 0.
        /// </summary>
        /// <param name="ID"></param>
        /// <returns></returns>
        ...
        // The function Insert() is called with the root of the tree as its first argument and ID as its second argument.
        /// </summary>
        /// <param name="ID"></param>
        /// <param name="data"></param>
        /// <returns></returns>
